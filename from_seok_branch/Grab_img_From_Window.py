...
cookie_save_x, cookie_save_y, cookie_save_w, cookie_save_h = 100,100,100,100
...
while (ret):
    ...
    if not cordinate_get:
        ...
        #print(grid_unit_length/window_x, grid_unit_length/window_y) #= 39 (x의 0.045774647887323945,  y의 0.08125)
        # 쿠키의 중심을 찾음
